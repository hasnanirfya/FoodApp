...
import com.jetpack.myfoodapp.ui.theme.MyFoodAppTheme
        ...
        Row (
            ...
            Row(Modifier
                ...
                Column(Modifier.padding(8.dp)) {
                    Text(text = "Rp 30.000", fontWeight = FontWeight.Bold, fontSize = 8.sp)
                    Text(text = "Points", color = Color.LightGray, fontSize = 6.sp)
                }
            }
            ...
            Row(Modifier
                ...
                Column(Modifier.padding(8.dp)) {
                    Text(text = "Rp 100.000", fontWeight = FontWeight.Bold, fontSize = 8.sp)
                    Text(text = "Top Up", color = MaterialTheme.colors.primary, fontSize = 6.sp)
                }
            }
        }
    }
...
fun Promotion() {
    LazyRow(
        ...
        item {
            PromotionItem(
//                imagePainter = painterResource(id = R.drawable.promotion) as Painter,
                imagePainter = painterResource(id = R.drawable.bg2_main) as Painter,
                title = "Fruit",
            subtitle = "Start @",
            header = "Rp 10.000",
...
//                imagePainter = painterResource(id = R.drawable.promotion),
                imagePainter = painterResource(id = R.drawable.bg3_main),
                title = "Meat",
                subtitle = "Discount",
                header = "20%",
